...
typedef struct tagRGBTRIPLE RGBTRIPLE, *PRGBTRIPLE, *LPRGBTRIPLE;
...
typedef struct tagRGBQUAD RGBQUAD, *PRGBQUAD, *LPRGBQUAD; 
...
typedef struct tagBITMAPINFO BITMAPINFO, *LPBITMAPINFO, *PBITMAPINFO; 
...
typedef struct tagDLGITEMTEMPLATE DLGITEMTEMPLATE;
typedef struct tagDLGITEMTEMPLATE *LPDLGITEMTEMPLATE;
typedef struct tagDLGITEMTEMPLATE *PDLGITEMTEMPLATE;
...
typedef struct tagDLGTEMPLATE DLGTEMPLATE;
...
typedef struct tagPALETTEENTRY PALETTEENTRY, *LPPALETTEENTRY, *PPALETTEENTRY; 
...
typedef struct tagLOGPALETTE LOGPALETTE, *LPLOGPALETTE, *PLOGPALETTE; 
