...
begin
  ...
  if MapAndLoad(PAnsiChar(NormalizePath(ImagePath)), nil, @ImageInfo, True, True) then
  try
...
begin
  ...
  if NtQuerySystemInformation(0, @SBI, SizeOf(SYSTEM_BASIC_INFORMATION),
    DWORD(ReturnLength)) <> STATUS_SUCCESS then
    RaiseLastOSError;
          ...
          try
            ...
            begin
              ...
              if not ReadProcessMemory(hProcess,
                ...
                SIZE_T(lpNumberOfBytesRead)) then
                RaiseLastOSError;
